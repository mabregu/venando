            ...
            <div class="container w-11/12 mx-auto">
                <div class="">
                    ...
                    <div class="grid grid-cols-4 px-10">
                        ...
                        <div class="font-bold text-center">Salgsvurdering</div>
                        <div  class="font-bold text-right">Handling</div>
                        ...
                        <div class="flex justify-end space-x-2">
                            ...
                            <img src="/img/star_filled_icon.png" alt="">
                        </div>
                        <hr class="col-span-4 mt-5 mb-5 bottom-2 w-full" align="center" size="2" width="50%" style="background-color: #9D9D9C" />
                        {{-- Full buyer descrip --}}
                        ...
                        <div class="col-span-2 hide_full_descrip mt-5">
                            <button
                            @click="details = true"
